...
send_mode=Verstuur email via de verbinding naar,3,Fail2ban uitvoerbestand
...
sendmail_cf=Volledig pad naar fail2ban.cf,8
sendmail_features=Fail2ban M4 basis directory,7
sendmail_mc=Volledig pad naar M4 config file,8
sendmail_pid=Volledig pad naar de Fail2ban PID files,9,40,2,\t
sendmail_smf=Solaris SMF service naam,3,Geen (gebruik hiervoor de PID files)
sendmail_command=Opdracht om Fail2ban te starten in server mode,0
sendmail_stop_command=Opdracht om Fail2ban te stoppen,3,Killen proces
sendmail_restart_command=Opdracht om Fail2ban te herstarten,3,Stop en start
makemap_path=Maak een map opdracht,0
sendmail_path=Fail2ban opdracht,0
alias_file=Volledig pad naar de Fail2ban alias file,3,Automatisch
